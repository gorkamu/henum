...
class DrupalScan(object):
    ...
    def scan(self):
        if self.debug > 1:
            ...
            print("  | Checking for Druapl login page")
        ...
        if self.debug > 1:		
            print("    | Checking for Drupal meta tag")	
        ...
        if self.debug > 1:
            print("    | Checking for Drupal copyright file")
        ...
        if self.debug > 1:
            print("    | Checking for Drupal modules readme file")
